...
// ESP32 IBD_2/IBC_2 DC motor drive — serial direction control, constant speed
// L_PWM → GPIO26,  R_PWM → GPIO27
...
#define CH_L       0      // LEDC channel for L_PWM
#define CH_R       1      // LEDC channel for R_PWM
#define PWM_FREQ   5000   // Hz
#define PWM_RES    8      // bits (0–255)
#define PWM_SPEED  200    // constant duty; tune to desired speed
