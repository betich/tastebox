      ...
      <div className="flex flex-col items-center justify-between h-full py-36 px-10">
        ...
        <div className="flex flex-col items-center">
          ...
          <div
            ...
            onPointerLeave={(e) => { if (dragging.current) onPointerUp(e) }}
          >
          ...
          <div
            ...
            style={{
              ...
              transition: snapping ? "transform 0.45s cubic-bezier(0.25,1,0.5,1)" : "none",
            }}
          >
            {/* Left */}
            <div
              ...
              style={{ width: 300, height: 360, opacity: 0.5, transform: "scale(0.88)", transition: "opacity 0.3s, transform 0.3s" }}
            >
              <img src={MENU[prev].img} className="w-full h-full object-cover" draggable={false} alt={MENU[prev].name} />
            </div>
            ...
            >
              <img src={MENU[index].img} className="w-full h-full object-cover" draggable={false} alt={MENU[index].name} />
            </div>
            ...
            <div
              ...
              style={{ width: 300, height: 360, opacity: 0.5, transform: "scale(0.88)", transition: "opacity 0.3s, transform 0.3s" }}
            >
              <img src={MENU[next].img} className="w-full h-full object-cover" draggable={false} alt={MENU[next].name} />
            </div>
          </div>
        </div>
        </div>

        <p className="text-[32px] text-neutral-500 font-semibold">Tap center to select</p>
